...
#
# 주어진 solution 함수는 후보의 수 N과 투표를 진행한 결과가 담긴 리스트 votes가
# 매개변수로 주어졌을 때, 가장 많은 표를 받은 후보의 번호를 return 하는 함수입니다.
...
def solution(N, votes):
    vote_counter = [0 for i in range(N+1)]  # 0부터 N까지
    for i in votes:
        vote_counter[i] += 1  # 1부터 N 번
